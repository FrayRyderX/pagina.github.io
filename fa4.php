...
session_start();
    ...
    $query = $connection->prepare("SELECT nombre FROM producto WHERE identificadorCategoria='2' AND id='8'");// Traduzco mi petición
    $query->execute(); //Ejecuto mi petición

    $name = $query->fetchAll(PDO::FETCH_ASSOC); //Me traigo los datos que necesito

    // Cuando la conexión está establecida...
    $query2 = $connection->prepare("SELECT precio FROM producto WHERE identificadorCategoria='2' AND id='8'");// Traduzco mi petición
        ...
        <form action="./registrodeproducto.php" method="post">
            <div class="container-lg" style="background-color: rgb(223, 217, 217) ;">
                <div class="row">
                    ...
                    <div class="col-5"><img src="./imagenes/fa4.jpg" width="60"><br> <br> 
                    <img src="./imagenes/fa4-2.jpg" width="60"> <br> <br> <img src="./imagenes/fa4-1.jpg" width="60"> </div>
                    <div class="col-6"><img src="./imagenes/fa4.jpg" width="500" width="principal"></div>
                    <div class="col-6">
