...
<body>
        ...
        <nav class="navbar navbar-expand-lg " style="background-color:black">
            <div class="container-fluid">
                ...
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <button type="button" class="btn btn-outline-light"><a class="nav-link" href="./registrarse.php">Registrarse</a></button>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <main style="background-color:rgb(103, 197, 214)">
        ...
        <h3 style="text-align:center; font-family:Minimalust Regular;">Bienvenido!!!</h3>
        <hr class="mb-5 mb-dark">
