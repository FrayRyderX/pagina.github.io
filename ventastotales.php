...
session_start();
    ...
    $total_income_query = $connection->prepare("SELECT sum(precio_venta) FROM facturaciontienda");
        ...
        <div class="container">
            <div class="ms-3 pt-3 mb-3">
                <div class="border border-dark" style="background-color:rgb(84, 112, 214)">
                    <h1 id="1" style="text-align:center; font-family:Minimalust Regular;">Ventas Totales</h1>
                    <br>
                    <p>Las ventas Totales son: <?php echo $total_income = $total[0]; ?></p>
                    <br>
