...
session_start();
    ...
    $query = $connection->prepare("SELECT nombre FROM producto WHERE identificadorCategoria='2' AND id='6'");// Traduzco mi petición
    $query->execute(); //Ejecuto mi petición

    $name = $query->fetchAll(PDO::FETCH_ASSOC); //Me traigo los datos que necesito

    // Cuando la conexión está establecida...
    $query2 = $connection->prepare("SELECT precio FROM producto WHERE identificadorCategoria='2' AND id='6'");// Traduzco mi petición
        ...
        <form action="./registrodeproducto.php" method="post">
            <div class="container-lg" style="background-color: rgb(223, 217, 217) ;">
                <div class="row">
                    ...
                    <div class="col-5"><img src="./imagenes/fa2.jpg" width="60"><br> <br> 
                    <img src="./imagenes/fa2-2.jpg" width="60"> <br> <br> <img src="./imagenes/fa2-3.jpg" width="60"> <br> <br> <img src="./imagenes/fa2-1.jpg" width="60"> </div>
                    <div class="col-6"><img src="./imagenes/fa2.jpg" width="500" width="principal"></div>
                    <div class="col-6">
                ...
                <div style="text-align:center;">
                    <br>
                    <div class="nav-item">
                        <button type="button" class="btn btn-outline-light"  style="background-color:rgb(87, 68,252)"><a class="nav-link" href="./FigurasDeAccion.php">Volver</a></button>
                    </div>
                </div>
        </form>
        <br>
