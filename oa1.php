...
session_start();
    ...
    // Cuando la conexión está establecida...
    $query2 = $connection->prepare("SELECT precio FROM producto WHERE identificadorCategoria='3' AND id='9'");// Traduzco mi petición
        ...
        <form action="./registrodeproducto.php" method="post">
            <div class="container-lg" style="background-color: rgb(223, 217, 217) ;">
                <div class="row">
                    ...
                    <div class="col-5"><img src="./imagenes/oa1.jpg" width="60"><br> <br> 
                    <img src="./imagenes/oa1-2.jpg" width="60"> <br> <br> <img src="./imagenes/oa1-1.jpg" width="60"> </div>
                    <div class="col-6"><img src="./imagenes/oa1.jpg" width="500" width="principal"></div>
                    <div class="col-6">
